...
public class OriginalMeshCut : MonoBehaviour
{
    ...
    private static Triangle _triangleCache = new Triangle(new Vector3[3], new Vector2[3], new Vector3[3], new Vector4[3]);
    ...
    #region Cutting
    // Caching
    private static Triangle _leftTriangleCache = new Triangle(new Vector3[3], new Vector2[3], new Vector3[3], new Vector4[3]);
    private static Triangle _rightTriangleCache = new Triangle(new Vector3[3], new Vector2[3], new Vector3[3], new Vector4[3]);
    private static Triangle _newTriangleCache = new Triangle(new Vector3[3], new Vector2[3], new Vector3[3], new Vector4[3]);
    // Functions
